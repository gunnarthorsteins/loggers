#TODO: Generate lines for aesthetic compartmentalization

import tkinter as tk


class Widget:
    """"Contains all the necessary methods to set up a functional widget. Is
    optimized for a 'vertical' (i.e. one-column) layout.
    ...
    def root_mkr(self):
        """Creates a GUI root. Should be the first method called after creating
    ...
    def frm_mkr(self, rel_w=1, rel_h=1):
        """Creates a GUI frame. Should be the second method called when
        creating the widget, after root_mkr().

        Params:
            rel_w (float): Normalized
            rel_h (float): Normalized
        """
    ...
    def btn_mkr(self, rel_y, txt, fun, invoke=False):
        ...
        Params:
            ...
            txt (str): The text displayed on the button.
        ...
        btn = tk.Button(self.frame,
                        ...
                        fg=self.props['BUTTON_FONT_COLOR'],
                        borderwidth=4)
    ...
    def rdbtn_mkr(self, rel_y, key, img, lambda_fun, kbrd_binding=None):
        ...
        Params:
            ...
            lambda_fun (function call): A function call [excl. lambda].
        ...
        rdbtn.place(relx=self.props['REL_X'],
                    rely=rel_y,
                    relwidth=self.props['REL_W'],
                    relheight=self.props['REL_H']*1.375)
        rdbtn.deselect()
        if kbrd_binding:
